...
const Home = () => {
  ...
  return (
    <div style={{ minHeight: '100vh', minWidth: '100vw', backgroundColor: '#0000', backgroundImage: `url("https://www.transparenttextures.com/patterns/gray-floral.p")` }}>

      <div className="container d-flex justify-content-center align-items-center text-center">
        <div className="row">
          <div className="col-lg-12 col-md-12 col-sm-12 col-12 mt-3"></div>
          <h1 className='heading' style={{ color: '' }}></h1>
        </div>
      </div>
        ...
        <div className="row">
          <div className="col-lg-6 col-md-6 col-sm-12 col-12 text-center mq" style={{ height: '55%' }}>
            ...
            <div className="CKedit d-flex justify-content-center mt-3 ">
              <div className="editor" style={{ backgroundColor: "#b1b1b19e" }}>
                <ReactQuill
